...
<div class="jumbotron">
  <div class="container">
    <h1 class="display-4">Sort By Location Of PC</h1>
  </div>
</div>  
...
<div class="container">
    <form action="locationsearch" method="POST">
        <div class="form-group">
            ...
            <input type="text" name="name" class="form-control" placeholder="Kumarghat...">
            <small id="emailHelp" class="form-text text-muted">Enter the Location Of the Authority Here.</small>
