 ...
 * @author Souvik
 */
@WebServlet(name = "antiviruscheck", urlPatterns = {"/antiviruscheck"})
public class antiviruscheck extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String name=null;
            String  checkby="Waether Antivirus Installed";
...
stmt.executeQuery("select * from dataentry where antivirus='"+name+"' ;");
...
{          out.println(e);               
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet antiviruscheck</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet antiviruscheck at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
