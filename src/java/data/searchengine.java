 ...
 * @author Sagar
 */
@WebServlet(name = "searchengine", urlPatterns = {"/searchengine"})
...
stmt.executeQuery("select * from dataentry where ipaddress='"+ipaddress+"' ;");
...
while(rs.next()){
            ...
            request.setAttribute("reportype",ipaddress);
            request.setAttribute("checkby2","IP Address");
