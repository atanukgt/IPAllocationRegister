 ...
 * @author Souvik
 */
@WebServlet(name = "namesearch", urlPatterns = {"/namesearch"})
...
stmt.executeQuery("select * from dataentry where lower(fname) like '%"+name+"%' ;");
...
while(rs.next()){
            ...
            request.setAttribute("checkby2", "By NAME");
...
{          out.println(e);               
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet namesearch</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet namesearch at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
