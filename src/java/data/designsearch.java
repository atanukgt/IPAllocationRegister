 ...
 * @author Souvik
 */
@WebServlet(name = "designsearch", urlPatterns = {"/designsearch"})
public class designsearch extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            /* TODO output your page here. You may use following sample code. */
             ...
             String name=request.getParameter("desig");
            
            if(name.equals(""))
            {   
                JOptionPane.showMessageDialog(null, "field cannot be empty");
                response.sendRedirect("searchbydesignation.jsp");
                return;
            }
...
stmt.executeQuery("select * from dataentry where designation like '%"+name+"%' ;");
...
while(rs.next()){
            ...
            request.setAttribute("checkby2", "Designation Search");
...
{          out.println(e);               
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet designsearch</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet designsearch at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
