...
<div class="jumbotron">
  <div class="container">
    <h1 class="display-4">Sort by Designation Of the Authority</h1>
  </div>
</div>  
...
<div class="container">
    <form action="designsearch" method="POST">
        <div class="form-group">
            <label>Designation Of Authority </label>
            <input type="text" name="desig" class="form-control" placeholder="BDO...">
            <small id="emailHelp" class="form-text text-muted">Enter the Designation Of the Authority Here.</small>
